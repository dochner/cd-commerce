  ...
  <QFooter elevated class="public-footer bg-dark">
    <div class="public-footer__wrapper">
      <QToolbar class="public-footer__toolbar justify-between q-pa-md">
        <div class="public-footer__toolbar-links flex flex-grow q-gutter-y-lg q-gutter-x-lg">
          <RouterLink
      ...
      <QToolbar>
        <QToolbarTitle class="public-footer__toolbar row q-gutter-x-md items-center q-pa-md">
          ...
          <div class="text-h6 text-weight-bold flex">{{APP_TITLE}}<span class="text-caption "> &copy; {{  actualYear }}</span></div>
        </QToolbarTitle>
      </QToolbar>
    </div>
  </QFooter>
