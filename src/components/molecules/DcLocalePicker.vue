...
<template>
  <QBtnDropdown color="dark" dropdown-icon="i-carbon-chevron-down" no-caps style="width: 152px;">
    <template #label>
      <div class="row q-gutter-x-sm items-center">
        <QIcon v-if="actualLocale.flag.includes('brazil')" name="i-twemoji:flag-brazil" />
    ...
    <QList class="bg-dark text-white">
